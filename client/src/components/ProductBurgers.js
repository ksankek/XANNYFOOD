...
const BurgersPage = observer(() => {
  ...
  useEffect( () => {
    ...
    fetchProductsWithId(3).then(data => product.setProducts(data)).finally( () => setLoading(false));;
  }, [])
  ...
  return (
  <div className="product-list burgers-page">
    <h1 className="title">Гамбургеры</h1>
